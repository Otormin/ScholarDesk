...
<head>
    ...
    <title>Scholar Desk - Select Semester</title>
        ...
        ?>
            <div class="courses-container">
                <div class="courses">
                    ...
                    <div class="courses-button"><a href="SemesterCourse.php?department=<?php echo urlencode($department); ?>&level=<?php echo urlencode($level); ?>&semester=<?php echo urlencode('1st Semester'); ?>"> View Courses </a></div>
                </div>
                <div class="courses">
                    <div><h3> 2nd Semester </h3></div>
                    <div class="courses-button"><a href="SemesterCourse.php?department=<?php echo urlencode($department); ?>&level=<?php echo urlencode($level); ?>&semester=<?php echo urlencode('2nd Semester'); ?>"> View Courses </a></div>
                </div>
            </div>
        <?php 
            }else{
